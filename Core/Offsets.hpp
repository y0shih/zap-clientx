...
constexpr long OFF_NAME_LIST = 0xc5dacc0;                     //[Miscellaneous]->NameList           Not sure
 
// HUD
constexpr long OFF_VIEWRENDER = 0x73df958;                    //[Miscellaneous]->ViewRenderer
...
constexpr long OFF_THIRDPERSON_OVERRIDE = 0x01d46910;         //thirdperson_override
