...
constexpr long OFF_NAME_LIST = 0xC5E1150;                     //[Miscellaneous]->NameList
constexpr long OFF_GAMEMODE = 0x0219e8b0;                     //mp_gamemode
constexpr long OFF_ITEM_ID = 0x1538;                          //m_customScriptInt
constexpr long OFF_PROP_SURVIVAL = 0x01dad470;                //CPropSurvival
constexpr long OFF_SIGNIFIER_NAME = 0x0468;                   //[RecvTable.DT_PropSurvival]m_iSignifierName
